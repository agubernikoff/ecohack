...
function Home() {
  return (
    <div style={{backgroundImage: `url("${Background}")`}} className="w-full h-screen flex items-center justify-center">
      <section className="text-white text-center max-w-3xl bg-black/50 p-10">
        <h1 className="text-4xl pb-4">Change the world and have fun while doing it!</h1>
        <p className="text-xl">Recycle Quest is an app that let's your organization compete side-by-side while creating positive change. Score points by recycling.</p>
