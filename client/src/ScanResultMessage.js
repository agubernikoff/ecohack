  ...
  const message =
    result === "success" ? (
      ...
      <>
        ...
        <p className="text-lg">Pleae Try Again</p>
      </>
    );
  console.log(user);
  return (
    <div className="text-2xl mb-10 font-bold flex flex-col items-center justify-center bg-white py-16 px-20 shadow-2xl rounded-3xl">
      ...
      <div className="flex">
      <button className="py-4 px-6 bg-light-green text-white mr-8 hover:bg-dark-green duration-300" onClick={() => navigate(`/leaders`)}>Return to Homepage</button>
      <button className="py-4 px-6 bg-black text-white mr-8 text-center hover:bg-dark-green duration-300" onClick={() => toggleIsScanning()}>
